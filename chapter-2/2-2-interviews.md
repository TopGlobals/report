...
- **Age**: 100% of the interviewees are young professionals between 22 and 30 years old, with an average age of 25.3 years.
- **Brands**: 66.7% (2 out of 3) of the users actively use Thermo (Thermo Scientific) and Eurobase (Biobase/Eurotec) equipment. Other identified brands include Inmunolab, CBIO, ICROMA, QCA, Wiener, and Umbrella Genomic.
- **Devices**: 100% of the personnel use Smartphones for their daily operations. Laptops represent the second most used device at 66.7%, followed by PCs (33.3%) and Smartwatches (33.3%).
- **Browsers**: Google Chrome holds a 100% adoption rate as the primary browser. Alternative browsers like Firefox and Edge are used by 33.3% of the segment.
- **Common Objectives**: Achieving complete exactness and security when monitoring the cold chain. Obtaining an application that displays real-time temperatures, location maps, and immediate "beeper-style" alerts detailing the exact location of misplaced reagents.
- **Common Challenges**: Dealing with disorganized inventory and the manual tracking of consumption. Wasting critical time searching for light- and heat-sensitive reagents that coworkers have relocated to incorrect refrigerators.
- **Common Motivations**: Fulfilling professional goals such as completing internships optimally, pursuing postgraduate degrees, and expanding the availability of complex analysis in their laboratories.
- **Common Frustrations**: The anxiety generated by sudden, unnotified temperature changes and the fear of facing financial deductions for equipment failures. The high stress caused by patient saturation, fatigue, and the constant risk of reagents expiring before use.

**Segment 2**

- **Age**: 100% of the interviewed technical staff are between 24 and 25 years old.
- **Brands**: 100% of the interviewees consider Thermo (Thermo Scientific) and Eurobase (Biobase/Eurotec) as their standard cold storage equipment references.
- **Devices**: 100% utilize a hybrid setup, relying on PCs for validations and patient registration, and Smartphones for personal communication and background monitoring.
- **Browsers**: 100% utilize Google Chrome as their primary browser. Brave and Edge are used as secondary options by 50% of the users respectively.
- **Common Objectives**: Accessing real-time temperature data remotely via a mobile application to avoid constant physical check-ups. Receiving automatic, personalized notifications—similar to WhatsApp alerts—running in the background to report optimal status or require manual reconfigurations.
- **Common Challenges**: Relying on basic digital screens with easily ignorable visual and sound alarms. Dealing with human errors, such as interns leaving refrigerator doors improperly closed, which leads to undetected temperature losses.
- **Common Motivations**: Proactively ensuring equipment integrity and keeping strict control over the order and expiration dates of reagents to prevent lengthy task repetitions, such as re-solidifying agars.
- **Common Frustrations**: The lack of automation in the public sector, which forces them to continue using outdated paper records. The sense of powerlessness when equipment breaks down and clinical staff cannot intervene, immediately halting work and provoking patient complaints.
